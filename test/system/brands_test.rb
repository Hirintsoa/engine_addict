...
class BrandsTest < ApplicationSystemTestCase
  ...
  test "should create brand" do
    ...
    fill_in "Financial value", with: @brand.financial_value
    fill_in "Foundator", with: @brand.foundator
    fill_in "Headquarter", with: @brand.headquarter
    fill_in "Logo", with: @brand.logo
    fill_in "Promotional phrase", with: @brand.promotional_phrase
